import os
rootdir = '/home/gabriel/fun'
os.chdir(rootdir)

with open('/home/gabriel/fun/tf-char-rnn-server/save/new/nohup.out', 'r') as nohup:
    data = nohup.readlines()
               #%%
...
#%%
for i,line in enumerate(data):
    data[i] = float(line.split('train_loss = ')[1][0:5])


data2 = data[50000:50100]
